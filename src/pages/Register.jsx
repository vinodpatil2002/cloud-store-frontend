  ...
  return (
    <div className="min-h-screen bg-[#0F0F0F] flex flex-col items-center justify-center px-4">
      ...
      >
        ...
        <h1 className="text-xl font-semibold text-[#FAFAFA] mb-1">Create account</h1>
        <p className="text-sm text-neutral-500 mb-8">Get started for free. No credit card required.</p>
        ...
        <p className="text-xs text-neutral-500 mt-6">
          ...
          <Link to="/login" className="text-neutral-300 hover:text-[#FAFAFA] transition-colors duration-150">
            Sign in
          </Link>
        </p>
      </motion.div>
